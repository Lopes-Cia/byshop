...
export default function CartPage() {
  ...
  if (!hasHydrated) {
    return (
      <div className="mx-auto max-w-4xl px-4 py-16 text-center sm:px-6 lg:px-8">
        <h1 className="mb-4 text-3xl font-bold text-gray-900">Carrinho</h1>
  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-8 sm:px-6 lg:px-8">
      <h1 className="mb-8 text-3xl font-bold text-gray-900">Carrinho</h1>
        ...
        <div className="bg-gray-50 p-6">
          ...
          <div className="mb-6 space-y-2">
            ...
            <div className="flex items-center justify-between">
              ...
              <span className="text-sm font-medium text-gray-900">
                {summary.shipping === 0 ? "Grátis" : `$${summary.shipping.toFixed(2)}`}
              </span>
            </div>
            <div className="flex items-center justify-between">
          ...
          <div className="flex flex-col gap-4 sm:flex-row">
            ...
            <Link href="/finalizar-compra" className="flex-1">
