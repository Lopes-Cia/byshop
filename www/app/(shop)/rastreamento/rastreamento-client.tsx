...
export default function TrackingClient({ initialOrderId }: Props) {
  ...
  const submit = (value: string) => {
    ...
    router.push(`/rastreamento?orderId=${encodeURIComponent(trimmed)}`);
  };
  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
      <div className="mb-8 space-y-2">
        <h1 className="text-4xl font-bold text-gray-900">Rastreamento do pedido</h1>
        ...
        <div className="grid gap-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Você encontra o ID do pedido em <Link href="/pedidos" className="underline">/pedidos</Link>
                .
              </CardDescription>
            </CardHeader>
                  ...
                  <div key={o.id} className="flex flex-col gap-2 rounded-lg border p-3 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <div className="flex gap-2">
                      ...
                      <Button asChild size="sm">
                        <Link href={`/pedidos/${encodeURIComponent(o.id)}`}>Ver pedido</Link>
                      </Button>
                    </div>
                  </div>
                ))}
        ...
        <div className="grid gap-6">
          <Card>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="flex flex-col gap-2 sm:flex-row">
                <Button asChild>
                  <Link href={`/pedidos/${encodeURIComponent(order.id)}`}>Ver detalhes do pedido</Link>
                </Button>
                <Button asChild variant="outline">
