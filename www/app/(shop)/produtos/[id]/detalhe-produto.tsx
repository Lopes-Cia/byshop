    ...
    <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
      <div className="grid grid-cols-1 gap-12 lg:grid-cols-2">
        ...
        <div className="space-y-6">
          ...
          {product.colors && (
            <div>
              <h3 className="mb-3 font-semibold text-gray-900">Cor</h3>
          ...
          {/* Quantity */}
          <div>
            <h3 className="mb-3 font-semibold text-gray-900">Quantidade</h3>
          ...
          <div className="space-y-4 border-t pt-6">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-muted-foreground text-sm">Em pedidos acima de $100</p>
              </div>
            </div>
            <div className="flex items-center space-x-3">
              <RotateCcw className="text-primary h-5 w-5" />
              <div>
                <p className="font-medium">Devolução em 30 dias</p>
                <p className="text-muted-foreground text-sm">Devolução grátis em até 30 dias</p>
              </div>
            </div>
          </div>
          ...
          {product.features && (
            <div className="border-t pt-6">
              <h3 className="mb-3 font-semibold text-gray-900">Principais recursos</h3>
      ...
      {relatedProducts.length > 0 && (
        <div className="mt-16">
          <h2 className="mb-8 text-2xl font-bold text-gray-900">Produtos relacionados</h2>
