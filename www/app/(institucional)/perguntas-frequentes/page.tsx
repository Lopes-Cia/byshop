...
const faqs = [
  {
    ...
    a: "Você pode acompanhar o status no carrinho/finalizar compra e, quando estiver logado, na área de pedidos. Para dúvidas, use a página de contato."
  },
  {
  ...
  },
  {
    ...
    a: "As opções e prazos aparecem na finalização de compra e na página de entrega."
  },
  {
    ...
    <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <div className="mt-10 grid grid-cols-1 gap-4 sm:grid-cols-3">
        <Button asChild variant="outline">
          <Link href="/entrega">Envio</Link>
        </Button>
        <Button asChild variant="outline">
          <Link href="/trocas-e-devolucoes">Devoluções</Link>
        </Button>
        <Button asChild>
